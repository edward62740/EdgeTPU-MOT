 ...
 * @param	clkin		: Input reference clock to PLL1 (***REMOVED***PLL) see #CHIP_CGU_CLKIN_T
 ...
 * @return	None
 * @note	This API will initialize the ***REMOVED***PLL (PLL1) to the frequency given by
 ...
 * 			SPI base clocks to ***REMOVED***PLL's output clock. If @a setbase is false then
 ...
 * @return	None
 * @note	This API will initialize the ***REMOVED***PLL (PLL1) to the maximum
