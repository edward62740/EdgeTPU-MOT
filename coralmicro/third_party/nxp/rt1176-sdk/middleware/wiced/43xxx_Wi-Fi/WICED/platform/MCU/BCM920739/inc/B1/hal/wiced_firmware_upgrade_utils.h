...
#define WICED_FW_UPGRADE_INITIAL_RE***REMOVED***DER       0xFFFFFFFF
...
#define WICED_FW_UPGRADE_REFLECT_RE***REMOVED***DER(X)    ((UINT32) wiced_firmware_upgrade_utils_reflect((X), WICED_FW_UPGRADE_WIDTH))
