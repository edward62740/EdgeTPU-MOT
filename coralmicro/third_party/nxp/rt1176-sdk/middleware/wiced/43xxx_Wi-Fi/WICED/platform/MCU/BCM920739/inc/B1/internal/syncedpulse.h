...
enum
{
    HW_LPO_SEL_***REMOVED***60HZ_CNT_READBACK_MASK = 0x0004, HW_LPO_SEL_***REMOVED***60HZ_CNT_READBACK_ENABLE = 0x0004, HW_LPO_SEL_***REMOVED***60HZ_CNT_READBACK_DISABLE = 0x0000, HW_LPO_SEL_TRIAC_OUTPUT_INVERT_ALL_MASK = 0x00F0, HW_LPO_SEL_TRIAC1_OUTPUT_INVERT_SHIFT = 4,
