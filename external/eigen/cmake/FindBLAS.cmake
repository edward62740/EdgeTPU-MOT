...
if (BLA_VENDOR MATCHES "Intel*" OR BLA_VENDOR STREQUAL "All")
  ...
  if(NOT BLAS_LIBRARIES OR BLA_VENDOR MATCHES "Intel*")
	...
	if (WIN32)
	  ...
	  set(BLAS_SEARCH_LIBS_WIN_***REMOVED*** "")
	  if (BLA_VENDOR STREQUAL "Intel10_32" OR BLA_VENDOR STREQUAL "All")
	    list(APPEND BLAS_SEARCH_LIBS_WIN_***REMOVED***
	  ...
	  foreach (***REMOVED*** ${BLAS_SEARCH_LIBS_WIN_***REMOVED***})
	    foreach (THREAD ${BLAS_SEARCH_LIBS_WIN_THREAD})
	      list(APPEND BLAS_SEARCH_LIBS
		"${***REMOVED***} ${THREAD} mkl_core${BLAS_mkl_DLL_SUFFIX}")
	    endforeach()
	  endforeach()
	else ()
	  if (BLA_VENDOR STREQUAL "Intel10_32" OR BLA_VENDOR STREQUAL "All")
